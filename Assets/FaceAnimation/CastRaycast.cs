...
public class CastRaycast : MonoBehaviour
{
    ...
    bool clicked = false;
    public List<Vertex[]> captueredPositions;
    ...
    private void Start()
    {
        captueredPositions = new List<Vertex[]>();
    }
    ...
    private void CaputeredPositions()
    {
        ...
        captueredPositions.Add(temp);
    }

    Mesh mesh;
    void CreateMesh()
    {
        Vertex[] vertices = captueredPositions[0];
    ...
    void AnimateFace()
    {
        ...
        if (captueredPositions.Count <= 2)
            return;

        Vertex[] startingPoint = captueredPositions[captueredPositions.Count - 2];
        Vertex[] endingPoint = captueredPositions[captueredPositions.Count - 1];
